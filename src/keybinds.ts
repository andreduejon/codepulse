...
export const KEYBINDS: Record<HelpTab, HelpRow[]> = {
  general: [
    ...
    { kind: "binding", key: "tab", desc: "Cycle provider view (Git → providers)", indent: 1 },
    { kind: "spacer" },
    ...
    { kind: "binding", key: "shift + ←/→", desc: "Switch project", indent: 1 },
    ...
    { kind: "spacer" },
    { kind: "section", label: "CI Log" },
    { kind: "binding", key: "c", desc: "Cycle view mode", indent: 1 },
    { kind: "binding", key: "esc", desc: "Close", indent: 1 },
    { kind: "binding", key: "o", desc: "Open provider run in browser", indent: 1 },
    { kind: "binding", key: "w", desc: "Toggle line wrap", indent: 1 },
    { kind: "binding", key: "↑/↓  or  j/k", desc: "Scroll lines", indent: 1 },
    { kind: "binding", key: "←/→  or  h/l", desc: "Previous / next GitHub job", indent: 1 },
    { kind: "spacer" },
    { kind: "section", label: "OpenShift Resource" },
    { kind: "binding", key: "esc", desc: "Close", indent: 1 },
    { kind: "binding", key: "w", desc: "Toggle line wrap", indent: 1 },
    { kind: "binding", key: "g/G", desc: "Top / bottom", indent: 1 },
    { kind: "binding", key: "↑/↓  or  j/k", desc: "Scroll resource JSON", indent: 1 },
    { kind: "spacer" },
  ...
  providers: [
    ...
    { kind: "section", label: "Jenkins" },
    {
      kind: "binding",
      key: "Enabled",
      desc: "If enabled, allows switching to the Jenkins provider in the graph view.",
      indent: 1,
    },
    {
      kind: "binding",
      key: "Username",
      desc: "Jenkins username for Basic auth.",
      indent: 1,
    },
    {
      kind: "binding",
      key: "Token",
      desc: "Environment variable holding a Jenkins API token. Default is JENKINS_TOKEN.",
      indent: 1,
    },
    {
      kind: "binding",
    ...
    },
    {
      kind: "binding",
      key: "New job",
      desc: "Add a job or multibranch pipeline URL. Type is detected automatically; up to 25 enabled branches load across all parents.",
      indent: 1,
    },
    { kind: "spacer" },
    { kind: "section", label: "OpenShift" },
    {
      kind: "binding",
      key: "Enabled",
      desc: "Allow switching to the OpenShift provider in the graph view.",
      indent: 1,
    },
    {
      kind: "binding",
      key: "Server",
      desc: "OpenShift API server URL.",
      indent: 1,
    },
    {
      kind: "binding",
      key: "Token",
      desc: "Environment variable holding an OpenShift API token. Default is OPENSHIFT_TOKEN.",
      indent: 1,
    },
    {
      kind: "binding",
      key: "Annotation",
      desc: "Build or ImageStreamTag annotation containing the commit SHA. Default is dev/commit-sha.",
      indent: 1,
    },
    {
      kind: "binding",
